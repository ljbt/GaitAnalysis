...
int creeAnalysePatient(char* nom, char* prenom, char* taille, char* poids, char **stringlongueurBras,char **stringlongueurJambe, char* claudification, char* marcheRegu, char* video, int nbImages, char* dateHeure );
